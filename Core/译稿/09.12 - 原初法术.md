...
照常，这些准则指的是具有基础距程、持续和目标的法术。改变这些参数时，应先计入等级变化，再乘除法术等级来得到效果。因此，一个拥有视觉距程的“凡俗静寂风”(Wind of Mundane Silence, PeVi) 版本，可以解除等级最高为（法术等级 -5 + 压力骰）一半的法术。该法术的力量中有十级用于把目标提高到房间，十五级用于把距程提高到视觉，只有剩余力量可用于法术本身。

原初法术的个体目标，可以指单个法术，也可以指单个物体或人物；群体同理。如果目标是物体或人物，则该原初法术会影响作用于此人身上的任何适合魔法，而不仅仅是一个法术。大多数这类法术只能施放在其他法术或个体之一上；但如果描述暗示两者都可以作为目标，那么就可以。例如，“反相魔镜”(Mirror of Opposition) 只能施放在其他法术上，而“虚假赋礼”(The Phantom Gift) 只能施放在人身上。

法术和魔法效果没有大小，因此大小修正不适用于个体目标原初法术的等级。不过，影响区域或多个法术的原初法术，必须照常因大区域或大量法术而提高等级。

以下准则主要提到法术。这是为了简洁，因为原初法术也可以影响来自魔法物品、魔法生物或恶魔的魔法效果。不过，除非特别说明，否则这些法术不影响魔法物品本身，只影响它们产生的效果。因此，“凡俗静寂风”可以解除魔法物品产生的石墙，但要解除物品本身的魔法，则需要“附魔尽除”(Disenchant)。
...
| 5 | • 创造一阵魔法爆发，使目标获得一个扭曲点数（给予扭曲的法术不能拥有高于瞬息的持续；注意，对法师这样做是一种攻击，显然违反法典）<br>• 降低奥法连接的衰退速度，如同该连接在第220页表格上提高一级（如果这使持续变为年或更久，持续仍以年计量；赫尔墨斯魔法不能在不于工坊中固定的情况下让奥法连接无限期持续） |
...
##### 残丝重织 (Restore the Faded Threads)
距离：接触，持续时间：直径，目标：圆环<br>
...
##### 伪鉴魔壳 (Shell of False Determinations)
...
##### 蔽秘魔壳 (Shell of Opaque Mysteries)
距离：接触，持续时间：瞬息，目标：个体，仪式<br>
此法术类似上文的“伪鉴魔壳”，但它会使所有调查该魔法物品的尝试彻底失败，除非法师的调查掷骰超过该仪式等级。一旦某位法师确定了某个特定外壳的存在（也就是克服了它），它就不再对该法师有任何力量。<br>
（基础效果，+1 接触）
...
一般而言，魔法残留按如下方式衰减。魔法一结束，量级立即减半。之后，每经过该法术的一个持续时间，就下降一。降到零后，残留衰减变慢。非仪式的瞬息、专注和直径持续的残留每月下降一，而其他效果的残留每年下降一。负量级 10 表示残留已完全消失，不再存在，无法被侦测。
...
##### 窥探显迹 (The Invisible Eye Revealed)
距离：自身，持续时间：专注，目标：接触<br>
施法者可以感觉到当前任何用来窥探他的魔法手段。具体表现会依照法术而变化，但通常感觉像有什么东西碰到法师的背。例如，被“水镜占卜”(Enchantment of the Scrying Pool) 窥探的法师可能感到湿润的手指，而被“不懈追索”(The Inexorable Search) 追踪的法师可能感到一根手指划过皮肤。此法术可侦测等级最高为本法术等级两倍的全视法术使用情况。之所以需要专门法术，是因为大多数全视法术都设计得很隐秘，且等级越高越隐秘。<br>
（基础效果）
...
##### 源质衡秤 (Scales of the Magical Weight)
距离：接触，持续时间：瞬息，目标：个体<br>
...
##### 洞穿妖精帷幕 (Piercing the Faerie Veil)
...
##### 活跃魔法视界 (Sight of the Active Magics)
距离：自身，持续时间：专注，目标：视觉<br>
你可以看见围绕事物和人物的法术“辉光”。辉光颜色表示作用于对象的法术型式，其颜色与“源质辨艺”（第367页）所述对应颜色一致。作用于对象的法术技法则由辉光形状识别，而非颜色。创生和掌控的辉光都非常有序。万变不断变动，全视通常也会变动，但更缓慢。湮灭辉光通常呈碎片状。因此，一个身上同时有“狂战士坚忍”(Endurance of the Berserkers) 和“窥探显迹”(The Invisible Eye Revealed) 的法师，其全身周围会有非常受控、有序的深红辉光，而双眼周围则环绕着缓慢变动的银色辉光。你应当注意：意象或原初法术可能被用来伪装辉光。另请注意，此法术会侦测到某些法术的残留。<br>
...
万变原初法术通过改变施法过程中创造法术的魔法能量来运作。法术是基础施法与万变原初效果结合的结果，并在施法和万变原初效果都完成后产生效果。这意味着万变原初法术的持续必须至少与目标法术的施展时间一样长，但不必像目标法术本身那样持续。对正常施展的范式法术而言，瞬息持续已经足够；但如果施展时间因任何原因更长，万变原初法术也必须拥有更长持续；太阳持续足以应付任何实际仪式。
...
##### 反相魔镜 (形态) (Mirror of Opposition (form))
距离：声音，持续时间：瞬息，目标：个体<br>
在另一个法术正在施展时施放到该法术上，会使目标法术具有与其正常效果完全相反的效果。此效果可作用于等级最高为“反相魔镜”法术（等级 -5）一半的法术。反转后的效果由指引者决定，但反转法术的目标通常仍与原法术相同。反转法术不能克服任何赫尔墨斯魔法限制。例如，如果施放了一个瞬息的湮灭肉身法术，反转效果很可能是一个太阳持续的创生肉身法术。此法术有十个版本，各自影响一种赫尔墨斯型式的法术。<br>
（基础效果，+2 声音）
...
##### 魔印遮蔽 (Shroud Magic)
距离：接触，持续时间：瞬息，目标：个体<br>
此法术允许法师压制或改变一个正在施展法术中的印记。被遮蔽法术的等级最高可达“遮蔽”等级的两倍，而*魔印遮蔽*拥有与被遮蔽法术所赋予者相同的印记（或同样没有印记）。<br>
（基础效果，+1 接触）
...
##### 解构（形态）魔法 (Unravelling the Fabric of (Form))
距离：声音，持续时间：瞬息，目标：个体<br>
...
##### 凡俗静寂风 (Wind of Mundane Silence)
距离：声音，持续时间：瞬息，目标：房间<br>
你升起一阵隐喻性的“微风”，将一区域内的魔法吹散，抵消其中任何法术的效果。如果以此法术的压力骰 + 法术等级能够达到某法术等级的两倍，你就能抵消该法术效果。若要影响拥有魔法抗力的生物身上的效果，包括绛咒，此法术必须穿透。若法术穿透，且其等级 + 压力骰达到绛咒 ×5 的两倍，则此法术解除该绛咒。“凡俗静寂风”不影响瞬息持续的法术。风所及区域附近的魔法事物会因这阵“微风”而轻微摇动。<br>
（基础效果，+2 声音，+2 房间）
...
| 5 | • 控制与四大超自然界域之一相关的任何离体魂灵（每个界域需要不同法术） |
| 10 | • 将原始源质从一个物理物体移到另一个物理物体，无需工坊 |
| 15 | • 召唤与四大超自然界域之一相关的任何离体魂灵（每个界域需要不同法术） |
...
##### 御魔圆环 (Circular Ward against Demons)
...
##### 维系难持法术 (Maintaining the Demanding Spell)
距离：接触，持续时间：直径，目标：个体<br>
你把此法术施放在一个你已经施展、并正通过专注维持的法术上。于是，该需要专注的法术会在此法术持续期间自动维持，无论你是否专注。若不重新专注于第一个法术，你不能改变其效果。例如，你可以用“无形力臂”(The Unseen Arm, ReTe 5) 在不专注的情况下把一件物体悬在空中，但移动该物体仍需要专注。为了在维持第一个法术的同时施展此法术，必须进行耐力 + 专注压力掷骰，对抗难度等级 6（比通常更低，因为这正是此法术的设计用途）。此法术只对等级等于或低于它的法术有效。<br>
（基础效果，+1 接触，+1 直径）
...
一位以魔法识别出隧道的法师（通过*窥探显迹*或类似法术）可以通过隧道向你施放法术，而他不必专注于保持隧道开启。如果这位法师就是隧道法术的目标，则视为他正在接触你。否则，他到你的有效距程等于他到隧道法术目标的距程。
...
抵消你所施展的一个法术，但只在你保持专注时有效。专注中断后，该法术效果恢复。要被压制的法术等级必须小于或等于此法术等级。被压制法术的效果约需一轮淡出，并在专注中断后再用一轮恢复。要受影响的法术必须处于活跃状态才能被压制；尤其是，它不能是瞬息持续。此法术的常见用途包括进入通常被魔法封锁的地点（例如用万变地封住你工坊的门，然后压制它以进入），以及避开陷阱（例如压制后门上的*守望结界* [ReVi 通用]）。此法术设计为在你做其他事情时维持，因此法师在所有专注掷骰上获得 +3 加值。<br>
（基础，+1 接触，+1 专注）
...
##### 聚兽源质 (Gather the Essence of the Beast)
距离：接触，持续时间：瞬息，目标：个体<br>

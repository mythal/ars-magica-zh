...
##### 抚平兽痛 (Soothe Pains of the Beast)
...
##### 伤兽安养 (True Rest of the Injured Brute)
...
（基础等级 5，+1 接触，+3 月，+2 群体，+2 尺寸，昆虫群重量相当于一千头猪，+1 必备技法带来的额外效果；因效果极其重大而为仪式）
...
##### 狼人寒颤 (Shiver of the Lycanthrope)
...
##### 兽心开卷 (Opening the Tome of the Animal's Mind)
...
动物并非可以无限变化；对一只动物使用过多此类法术且维持过久，可能扭曲其自然体质，甚至毁灭它。可以查阅万变肉身法术，以获得更多关于万变动物法术的思路和准则。万变动物法术中常见的法师印记，是让动物以某种奇怪方式发生变化。被弗兰博的朱利安 (Julian of Flambeau) 用 *兽躯重塑* (The Beast Remade, MuAn 25) 变形的野兽，在新形态下可能会有鲜红色毛发；而由梅里尼塔的西尔瓦 (Silva of Merinita) 用 *饕兽化蟾* (Transformation of the Ravenous Beast to the Torpid Toad, MuAn 30) 创造的蟾蜍，可能会带有滑稽的色彩。
...
| 4 | • 对野兽进行重大改变，同时使其明显仍是同一种动物（例如，让一匹马变大并改变其颜色）<br>• 以轻微反常的方式改变由动物制品制成的事物 |
| 5 | • 将一种动物变成不同的动物<br>• 以微小的方式改变动物，使其变得反常（例如，将马皮毛的颜色改成符合结社徽章的颜色）<br>• 以重大且反常的方式改变由动物制品制成的事物 |
| 10 | • 将一种动物变成人（尽管它保留了其动物思维且不会获得灵魂；需要肉身必备技法）<br>• 将一种动物变成植物（需要植物必备技法） |
| 15 | • 以重大且反常的方式改变动物（例如，给马配上爪子、獠牙和带有鳞片的坚甲）<br>• 将动物变成无生命的物品（需要适当的必备技法） |
| 25 | • 以反常的方式彻底改变动物（例如，给马长出翅膀）；赋予动物“魔法”能力，例如喷火能力（需要对应能力的必备技法） |
...
##### 不侵丝衣 (Doublet of Impenetrable Silk)
...
##### 虫豸巨化 (Growth of the Creeping Things)
...
##### 缩兽术 (Beast of Minuscule Proportions)
...
##### 饕兽化蟾 (Transformation of the Ravenous Beast to the Torpid Toad)
...
| 3 | • 处理和加工由动物制品制成的物品 |
| 4 | • 安抚动物 |
| 5 | • 操纵动物的情绪<br>• 麻痹动物<br>• 抵御动物或由动物制品制成的物品（接触、环、圆环）<br>• 控制与动物相关的离体魂灵<br>• 使害虫在适当物质（如肉、植物、土壤或水）中自发生成 |
...
##### 巨象畏鼠 (Panic of the Elephant's Mouse)
...
（基础等级 10，+1 目光，+1 专注，+1 尺寸）

##### Mastering the Unruly Beast

##### 制御桀兽 (Mastering the Unruly Beast)

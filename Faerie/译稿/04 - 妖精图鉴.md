...
*致命经血 (Fatal Menses)*：0 点，恒定：（5 点精巧点用于降低消耗）一种类似蝎毒的毒液不断从 Lamashtu 身上滴落。她飞行时，毒液会形成细雾。Lamashtu 飞过水井上方时会污染井水，使接下来一周内饮用井水的人全都重病。她的毒液也能引发足以杀死体弱者或子宫内胎儿的恶疾。若她愿意，庄稼和动物也会在她飞过时死去。（此处将其视为 50 级效果，基于 *Treading the Ashen Path*，即 PeHe 30，+10（加入人类与动物的必要条件），+10 将 Mom（瞬息）持续时间改为 Sun（日），+5 恒定，-5 不再是花哨效果。将此力量视为一种魔法力量，而非毒物。）
...
*心脏震颤 (Lurching heart)*：4 点，恒定，Corpus：fachan 看起来如此可怖，任何看见它的角色都必须进行 Brave 掷骰，对抗难度等级 9。若失败，他们的心脏会不受控制地颤动，直到鼓起勇气为止。勇气掷骰成功之前，这种心脏抽紧每轮都视为一处新的轻伤。Fachan 的伟大国王只凭存在就能以恐惧击死人类，一些法师也曾遇到造成比这里描述更严重伤害的 fachan。（35 法术等级（基础 5 +3 视线 +2 日 +1 恒定）+ 由精巧点提供的 15 点穿透 xp。）
